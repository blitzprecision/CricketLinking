...
{
    class ComputeSingleBallAccuracySubClassesSemantics
    {
        ...
        static void Main(string[] args)
        {
            ...
            StreamWriter sw = new StreamWriter(dir + "SB_DirStructuredSimSubClassesSemantics.txt");
            loadIdealBalls();
                        ...
                        foreach (string sim in sims)
                        {
                            foreach (string method in methods)
                            {
                                for (double lambda = 0; lambda <= 1.0; lambda += 0.1)
                                {
                                    ...
                                    {
                                        string filename = dir + "SB_" + method + "_" + sim + "_" + coref + "_" + mc + "_" + type + "_" + lambda + "_mention2Balls.txt";
                                        bool success = false;
                                        try
                                        {
                                        ...
                                        if (!success)
                                            continue;
                                        sw.Write(subclass + "\t" + mc + "\t" + coref + "\t" + sim + "\t" + method + "\t" + lambda + "\t" + type + "\t");
